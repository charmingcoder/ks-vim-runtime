...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
map <leader>e :e! ~/.ks-vim-runtime/my_configs.vim<cr>
autocmd! bufwritepost ~/.ks-vim-runtime/my_configs.vim source ~/.ks-vim-runtime/my_configs.vim
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
try
    set undodir=~/.ks-vim-runtime/temp_dirs/undodir
    set undofile
catch
endtry
